        ...
        <div id="editSection">
            ...
            <form class="row g-3" method="POST" id="editForm">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationDefault01" name="name" value="<?php echo $row['addressName'] ?>" required>
                </div>

                <div class="col-md-6">
                    <label for="validationDefault02" class="form-label">Unit:</label>
                    <input type="text" class="form-control" id="validationDefault02" name="unit" value="<?php echo $row["unit"] ?>" required>
                </div>

                <div class="col-md-12">
                    <label for="validationDefault02" class="form-label">Address:</label>
                    <input type="text" class="form-control" id="validationDefault02" name="address" value="<?php echo $row["address"] ?>" required>
                </div>

                <div class="col-md-6">
                    <label for="validationDefault02" class="form-label">City:</label>
                    <input type="text" class="form-control" id="validationDefault02" name="city" value="<?php echo $row["city"] ?>" disabled>
                </div>

                <div class="col-md-6">
                    <label for="validationDefault02" class="form-label">State:</label>
                    <input type="text" class="form-control" id="validationDefault02" name="state" value="<?php echo $row["state"] ?>" disabled>
                </div>

                <div class="col-md-12">
                    <label for="validationDefault02" class="form-label">Postcode:</label>
                    <input type="text" class="form-control" id="validationDefault02" name="postcode" value="<?php echo $row['postcode'] ?>" disabled>
                </div>
