            ...
            <div class="form-container">
                <form id="register-form" class="row g-3" method="POST" action="../backend/registerUser.php">
                    ...
                    <div class="col-md-12">
                        ...
                        <p id="password_error" style=" color: red; display: none;">Your password length needs to be at
                            least
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="password" class="form-control" id="inputPassword4" name="confirmedPassword"
                            required>
