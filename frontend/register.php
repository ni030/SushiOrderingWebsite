            ...
            <div class="form-container">
                <form id="register-form" class="row g-3" method="POST" action="../backend/registerUser.php">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="error" id="email_error">Email Exist!</p>
                    </div>

                    <div class="col-md-12">
                        <label for="validationDefault02" class="form-label">Mobile Number</label>
                        <input type="text" class="form-control" id="validationDefault02" name="mobileNum" placeholder="0123456789" required>
                        <p class="error" id="phone_error">* Mobile Number Exist!</p>
                    </div>
                    ...
                    <p style="margin-top:0px;" class="error" id="password_error">* Your password length needs to be at
                        least
                    ...
                    <p style="margin-top:0px;" class="error" id="matched_error">* Your password does not match!
