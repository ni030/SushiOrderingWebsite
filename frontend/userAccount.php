...
<body>
    ...
    <div class="content">
        ...
        <div id="userProfile">
            <h1>My Profile</h1>
            <form class="row g-3" method="POST" action="../backend/updateProfile.php">
                <div class="col-md-6">
                    <label for="validationDefault01" class="form-label">First name</label>
                    <input type="text" class="form-control" id="validationDefault01" name="firstName" value="<?php echo $row['firstName'] ?>" required>
                </div>

                <div class="col-md-6">
                    <label for="validationDefault02" class="form-label">Last name</label>
                    <input type="text" class="form-control" id="validationDefault02" name="lastName" value="<?php echo $row['lastName'] ?>" required>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="validationDefault02" name="mobileNum" value="<?php echo $row['mobileNum'] ?>" disabled>
                </div>
