...
('M034', 'Family Feast Combo', 'home1.png', 'sushi', 'Ideal for gatherings and family meals where everyone can enjoy a taste of Japan together.', 59.90);
('M035', 'Solo Savory Combo', 'home2.png', 'sushi', 'Tailored for sushi enthusiasts dining alone or with a companion', 29.90);
('M036', 'Sashimi Sensation Combo', 'home3.png', 'sushi', 'Designed to delight sashimi aficionados with its artful presentation', 79.90);
